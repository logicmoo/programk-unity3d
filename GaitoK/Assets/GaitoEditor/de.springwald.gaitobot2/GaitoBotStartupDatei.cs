...
// Type: de.springwald.gaitobot2.GaitoBotStartupDatei
...
{
  public class GaitoBotStartupDatei
  {
    public GaitoBotStartupDatei()
    {
    }

    public GaitoBotStartupDatei(string startupDateiInhalt)
    {
    }
  }
}
